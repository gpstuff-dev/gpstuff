...
function testEstimatesIA(testCase)
  verifyVarsEqual(testCase, getName(), {'Elth', 'Elth2'}, ...
    'RelTolElement', 0.1, 'RelTolRange', 0.02)
end

function testPredictionIA(testCase)
  verifyVarsEqual(testCase, getName(), {'Ef', 'Varf'}, {@mean, @mean}, ...
    'RelTolElement', 0.1, 'RelTolRange', 0.02)
end
