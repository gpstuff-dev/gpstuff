...
function testPredictions(testCase)
  verifyVarsEqual(testCase, getName(), {'pmu'}, {@(x)x(:,1)}, ...
    'RelTolElement', 0.05, 'RelTolRange', 0.01)
  verifyVarsEqual(testCase, getName(), {'pmu'}, {@(x)x(:,2)}, ...
    'RelTolElement', 0.05, 'RelTolRange', 0.01)
  verifyVarsEqual(testCase, getName(), {'pmu'}, {@(x)x(:,3)}, ...
    'RelTolElement', 0.05, 'RelTolRange', 0.01)
end
