...
observation $i$. Here we present only the likelihood function because we don't have observation model for the censoring. The use of Weibull model with survival data is
