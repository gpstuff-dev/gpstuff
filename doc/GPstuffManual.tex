...
and without monotonicity constraint. The monotonicity constraint
...
larger ages where ther is less observations, but overall reduction in
uncertainty realted to the latent function can be seen.
