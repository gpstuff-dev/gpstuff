function [p,pq,xt] = lgcp(x,varargin)
...
%       'normalize' is optional false (default) or true, telling whether total 
%         intensity is normalized to 1. Mean normalized intensity can be used
%         to approximatie density estimate
% 
