...
gpcf1 = gpcf_sexp('init', nin, 'lengthScale', repmat(10,1,nin), 'magnSigma2', 0.2^2);
%gpcf1 = gpcf_sexp('init', nin, 'lengthScale', 10, 'magnSigma2', 0.2^2);
...
gp = gp_init('init', nin, 'logistic', {gpcf1}, [], 'jitterSigmas', 1)   %{gpcf2}
...
% Sample 
 [r,g,rstate2]=gp_mc(opt, gp, x, y, [], [], r, rstate1);
