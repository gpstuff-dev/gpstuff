...
%    In addition, this function also optimizes the hyperparameters of the
%    GP. Monotonicity is forced by GP prior by adding virtual observations 
