...
% allow use with or without init and set options
  ...
  switch do
    case 'init'
      ...
      lik.fh_pak = @lik_logit_pak;
      lik.fh_unpak = @lik_logit_unpak;
      lik.fh_ll = @lik_logit_ll;
      lik.fh_llg = @lik_logit_llg;    
      lik.fh_llg2 = @lik_logit_llg2;
      lik.fh_llg3 = @lik_logit_llg3;
      lik.fh_tiltedMoments = @lik_logit_tiltedMoments;
      lik.fh_predy = @lik_logit_predy;
      lik.fh_recappend = @lik_logit_recappend;
  ...
  function [lik, w] = lik_logit_unpak(w, lik)
  ...
  function logLik = lik_logit_ll(lik, y, f, z)
  ...
  %   LIK_LOGIT_LLG, LIK_LOGIT_LLG3, LIK_LOGIT_LLG2, GPLA_E
    ...
    logLik = sum(-log(1+exp(-y.*f)));
  end


  function deriv = lik_logit_llg(lik, y, f, param, z)
  ...
  function g2 = lik_logit_llg2(lik, y, f, param, z)
  ...
  function third_grad = lik_logit_llg3(lik, y, f, param, z)
  ...
  function [m_0, m_1, sigm2hati1] = lik_logit_tiltedMoments(lik, y, i1, sigm2_i, myy_i, z)
  ...
  %
  %   Description         
  %   [EY, VARY] = LIK_LOGIT_PREDY(LIK, EF, VARF)
  ...
  %    This is private function for lik_logit.
  %  
  %   See also
  ...
  %  gp_mc
    ...
    if nargin == 2
      ...
      reclik.fh_pak = @lik_logit_pak;
      reclik.fh_unpak = @lik_logit_unpak;
      reclik.fh_ll = @lik_logit_ll;
      reclik.fh_llg = @lik_logit_llg;    
      reclik.fh_llg2 = @lik_logit_llg2;
      reclik.fh_llg3 = @lik_logit_llg3;
      reclik.fh_tiltedMoments = @lik_logit_tiltedMoments;
      reclik.fh_predy = @lik_logit_predy;
      reclik.fh_recappend = @lik_logit_recappend;
      return
    end
