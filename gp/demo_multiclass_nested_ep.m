%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is a short demo of the fully-coupled nested EP implementation for
% Gaussian process classification with a multinomial probit likelihood
% described in
%
...
%- Data description
%
% The data used in this demo is the same used by Radford M. Neal
% in his three-way classification example in Software for Flexible
% Bayesian Modeling
