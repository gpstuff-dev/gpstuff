...
% Evaluate the 10-fold cross validation results. 
opt.nsamples=50;
[mlpd_cv(3), Var_lpd_cv(3)] = gp_kfcv(gp, x, y, 'inf_method', 'MCMC', 'opt', opt, 'SAVE', 0);
...
[mlpd_cv(4), Var_lpd_cv(4)] = gp_kfcv(gp, x, y, 'inf_method', 'IA', 'opt', opt, 'SAVE', 0);
...
% Then the 10 fold cross-validation.
[mlpd_cv(8), Var_lpd_cv(8)] = gp_kfcv(gp, x, y, 'inf_method', 'IA', 'opt', opt, 'SAVE', 0);
