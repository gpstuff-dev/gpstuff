...
pl = prior_t('s2',0.1);
pm = prior_t('s2',2); 
gpcf1 = gpcf_sexp('lengthScale', 0.06, 'magnSigma2', 1, ...
                  'lengthScale_prior', pl, 'magnSigma2_prior', pm);
gpcf2 = gpcf_exp('lengthScale', 0.25, 'magnSigma2', 1, ...
                 'lengthScale_prior', pl, 'magnSigma2_prior', pm);
gpcf3 = gpcf_exp('lengthScale', 0.45, 'magnSigma2', 1, ...
                 'lengthScale_prior', pl, 'magnSigma2_prior', pm);

% Create the likelihood structure. Don't set prior for sigma2 if covariance
% function magnitude for noise process has a prior.
lik = lik_epgaussian('sigma2', 0.1, 'sigma2_prior', prior_fixed(), ...
...
subplot(2,1,1)
plot(xt,Ef(:,1),'b',xt,prctmus(:,1),'r',xt,prctmus(:,3),'r', x, f1, 'k')
