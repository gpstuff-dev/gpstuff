...
% License.txt, included with the software, for details.
  ...
  function [Ey, Vary, Py] = lik_negbinztr_predy(lik, Ef, Varf, yt, zt)
  %LIK_NEGBINZTR_PREDY  Returns the predictive mean, variance and density of y
  %
  %  Description         
  %    [EY, VARY] = LIK_NEGBINZTR_PREDY(LIK, EF, VARF) takes a
  %    likelihood structure LIK, posterior mean EF and posterior
  %    Variance VARF of the latent variable and returns the
  %    posterior predictive mean EY and variance VARY of the
  %    observations related to the latent variables
  %        
  %    [Ey, Vary, PY] = LIK_NEGBINZTR_PREDY(LIK, EF, VARF YT, ZT)
