function [Ef, Varf, noisyY] = gp_pred(gp, tx, ty, x, predcf, tstind)
...
%
%	[F, VarF, sampY] = GP_PRED(GP, TX, TY, X, PREDCF, TSTIND) returns also a sample
%       from predictive distribution of observation sampY. This is needed for example
%       in the Student-t noise model. NOTE! in FIC/PIC the prediction NoisyY is made at
%       the training points!
%
%	See also
