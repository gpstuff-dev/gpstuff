...
%
%  Description
%    GPCF = GPCF_PPCS0('nin', NIN, OPTIONS) Create and initialize
...
%
%    GPCF = GPCF_PPCS0(GPCF, OPTIONS) Set the fields of GPCF as
...
%       
%    NOTE2! Use of gpcf_ppcs0 requires that you have installed
  ...
  elseif isstruct(varargin{1})
    ...
    switch do
      case 'init'
        ...
        if isempty(nin)
            error('nin has to be given in init: gpcf_ppcs0(''init'',''nin'',NIN,...)')
        end
    ...
    %GPCF_PPCS0_UNPAK  Sets the covariance function parameters pack into the structure
    %
    %  Description
    ...
    %   th is a vector of PPCS0 parameters and J is the Jacobian of
    ...
    %
    %  Description
    %   [DKff, GPRIOR] = GPCF_PPCS0_GHYPER(GPCF, X) 
    ...
    %
    %   [DKff, GPRIOR] = GPCF_PPCS0_GHYPER(GPCF, X, X2) 
    %   takes a covariance function data structure GPCF, a matrix X of
    %   input vectors and returns DKff, the gradients of covariance
    ...
    %   vector of hyperparameters
    %
    %   [DKff, GPRIOR] = GPCF_PPCS0_GHYPER(GPCF, X, [], MASK) 
    %   takes a covariance function data structure GPCF, a matrix X of
    ...
    %
    %  Description
    %   DKff = GPCF_PPCS0_GHYPER(GPCF, X) 
    %   takes a covariance function data structure GPCF, a matrix X of
    %   input vectors and returns DKff, the gradients of covariance
    %   matrix Kff = k(X,X) with respect to X (cell array with matrix
    %   elements)
    %
    %   DKff = GPCF_PPCS0_GHYPER(GPCF, X, X2) 
    %   takes a covariance function data structure GPCF, a matrix X of
    %   input vectors and returns DKff, the gradients of covariance
    ...
    %
    %         Description         
    %         C = GP_PPCS0_COV(GP, TX, X) takes in covariance function of a
    ...
    %
    %         Description
    %         C = GP_PPCS0_TRVAR(GPCF, TX) takes in covariance function 
