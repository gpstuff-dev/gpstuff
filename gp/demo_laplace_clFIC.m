...
gp = gp_init('init', 'FIC', nin, 'probit', {gpcf1}, [], 'jitterSigmas', 0.01, 'X_u', U);   %{gpcf2}
gp = gp_init('set', gp, 'latent_method', {'Laplace', x, y, 'all'});
gradcheck(gp_pak(gp,'all'), @gpla_e, @gpla_g, gp, x, y, 'all')
...
[Eftest, Varftest, p1test] = la_pred(gp, x, y, tx, 'hyper');
