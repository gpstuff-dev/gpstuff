...
function [w,s,h] = lik_weibull_pak(lik)
...
function [logM_0, m_1, sigm2hati1] = lik_weibull_tiltedMoments(lik, y, i1, sigma2_i, myy_i, z)
...
%    GPEP_E
 ...
 if numel(z)==0
  ...
  for i=1:length(i1)
    ...
    [tf,minf,maxf]=init_weibull_norm(yy(i),myy_i(i),sigma2_ii,yc(i),r);
