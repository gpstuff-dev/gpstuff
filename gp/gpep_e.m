...
%                 [m_0, fhncnt] = quadgk(zm, lambdaconf(1), lambdaconf(2), 'AbsTol',tol,'RelTol',0);
%                 [m_1, fhncnt] = quadgk(fm, lambdaconf(1), lambdaconf(2), 'AbsTol',tol,'RelTol',0);
%                 [sigm2hati1, fhncnt] = quadgk(sm, lambdaconf(1), lambdaconf(2), 'AbsTol',tol,'RelTol',0);
                % 10932
                % 3644
                % 3644
                % 3644
