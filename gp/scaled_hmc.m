...
%
%   Description
%   [F, ENERG, DIAG] = SCALED_HMC(F, OPT, GP, X, Y) takes the current latent 
...
%   p(f|y,th).
%
%   The latent values are whitened with an approximate posterior covariance before 
%   the sampling. This reduces the autocorrelation and speeds up the mixing of the 
%   sampler. See Vanhatalo and Vehtari (2007) for details on implementation.
%
%   See also
%   GP_MC
