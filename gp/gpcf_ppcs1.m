...
% License.txt, included with the software, for details.
  ...
  if init
    ...
    gpcf.fh.e = @gpcf_ppcs1_e;
    gpcf.fh.ghyper = @gpcf_ppcs1_ghyper;
  ...
  %GPCF_PPCS1_PAK  Combine GP covariance function hyper-parameters into
  %               one vector.
  %
  %  Description
  ...
  %    where th is a vector of PPCS1 parameters and J is the
  ...
  %GPCF_PPCS1_GHYPER  Evaluate gradient of covariance function and
  %                  hyper-prior with respect to the hyperparameters.
  %
  %  Description
  %    [DKff, GPRIOR] = GPCF_PPCS1_GHYPER(GPCF, X) takes a
  ...
  %
  %    [DKff, GPRIOR] = GPCF_PPCS1_GHYPER(GPCF, X, X2) takes a
  %    covariance function structure GPCF, a matrix X of input
  %    vectors and returns DKff, the gradients of covariance matrix
  ...
  %    vector of parameters.
  %
  %    [DKff, GPRIOR] = GPCF_PPCS1_GHYPER(GPCF, X, [], MASK) takes a
  %    covariance function structure GPCF, a matrix X of input
  ...
  %
  %  Description
  %    DKff = GPCF_PPCS1_GHYPER(GPCF, X) takes a covariance
  ...
  %
  %    DKff = GPCF_PPCS1_GHYPER(GPCF, X, X2) takes a covariance
  %    function structure GPCF, a matrix X of input vectors
  %    and returns DKff, the gradients of covariance matrix Kff =
  ...
  % Initialize record
    if nargin == 2
      ...
      reccf.fh.e = @gpcf_ppcs1_e;
      reccf.fh.g = @gpcf_ppcs1_g;
