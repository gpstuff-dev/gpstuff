function likelih = likelih_probit(varargin)
%LIKELIHOOD_PROBIT   Create a Probit likelihood structure 
%
%     Description
%       LIKELIH = LIKELIH_PROBIT Create and initialize Probit
%       likelihood for classification problem with class labels
%       {-1,1}.
%  
