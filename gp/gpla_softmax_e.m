function [e, edata, eprior, f, L, a, E, M, p] = gpla_softmax_e(w, gp, x, y, varargin)
%GPLA_E Construct Laplace approximation and return marginal log posterior
%       estimate for softmax likelihood
%
%     Description
%	GP = GPLA_SOFTMAX_E('init', GP, X, Y, OPTIONS) takes a GP data structure
%        GP together with a matrix X of input vectors and a matrix Y
%        of target vectors, and initializes required fiels for the
%        Laplace approximation.
%
%	E = GPLA_SOFTMAX_E(W, GP, X, Y, OPTIONS) takes a GP data structure GP
...
%
%	[E, EDATA, EPRIOR] = GPLA_SOFTMAX_E(W, GP, X, Y, OPTIONS) returns also 
...
%
%	See also
%       GPLA_SOFTMAX_G, GPLA_G, LA_PRED, GP_E

% Copyright (c) 2010 Jaakko Riihimäki, Pasi Jylänki, Jarno Vanhatalo, Aki Vehtari
...
%                     end
                  ...
                  case 'newton'
                    ...
                    %W = -feval(gp.likelih.fh_g2, gp.likelih, y, f2, 'latent', z);
                    %dlp = feval(gp.likelih.fh_g, gp.likelih, y, f2, 'latent', z);
                    %lp_new = feval(gp.likelih.fh_e, gp.likelih, y, f2, z);
                    ...
                    while lp_new - lp_old > tol
                        ...
                        % b = -feval(gp.likelih.fh_g2, gp.likelih, y, f2, 'latent', z)*f + ...
                        %       feval(gp.likelih.fh_g, gp.likelih, y, f2, 'latent', z);
                        ...
                        lp_new = -a'*f/2 + feval(gp.likelih.fh_e, gp.likelih, y, f2, z);
...
%                     end
                ...
                logZ = a'*f/2 - feval(gp.likelih.fh_e, gp.likelih, y, f2, z) + det_term;
                edata = logZ;
