...
%	combines the hyper-parameters into a single row vector W. This is
% a mandatory subfunction used for example in energy and gradient
% computations.
%
...
%	hyper-parameters has been set to the of W. This is a mandatory
