...
%   hl=line(repmat(prctile(ld50s',[2.5 50 97.5]),2,1),[0 0 0;2150 2300 2150],'Color','k');
  hl=line(repmat(prctile(ld50s',2.5),1,2),[0 2150],'Color','k');
  hl=line(repmat(prctile(ld50s',50),1,2),[0 2300],'Color','k');
  hl=line(repmat(prctile(ld50s',97.5),1,2),[0 2150],'Color','k');
  q2=qqplot(rmc.ld50s);
  drawnow
