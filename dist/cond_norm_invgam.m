...
if size(a2.s,2)>1
  for i=1:m
    r(i)=sqrt(invgamrand1((a2.nu*a2.s(i).^2+sumsqr(x(:,i)))/(a2.nu+n), a2.nu+n));
  end
else
  a2nun=a2.nu+n;
  a2nua2s2=a2.nu*a2.s.^2;
  for i=1:m
    r(i)=sqrt(invgamrand1((a2nua2s2+sum(x(:,i).^2))./a2nun, a2nun));
  end
end
