function p = prior_sqrtt(do, varargin)
% PRIOR_SQRTT Student-t prior structure for the square root of the parameter
%       
%        Description
%        P = PRIOR_SQRTT('INIT') returns a structure that specifies Student's
%        t-distribution prior for the square root of the parameter.
%
