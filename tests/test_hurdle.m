...
function testPredictiveMeanAndVariance_LatentZeroProcess(testCase)
  verifyVarsEqual(testCase, getName(), {'Efz','Varfz'}, ...
    'RelTolElement', 0.05, 'RelTolRange', 0.01)
end

function testPredictiveMeanAndVariance_LatentCountProcess(testCase)
  verifyVarsEqual(testCase, getName(), {'Efc','Varfc'}, ...
    'RelTolElement', 0.05, 'RelTolRange', 0.01)
end
